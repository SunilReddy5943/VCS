  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        isScrolled
          ? 'glass shadow-subtle py-3 bg-white/70 backdrop-blur-xl'
          : 'bg-transparent py-5'
      )}
    >
      <nav className="container-vcs flex items-center justify-between" aria-label="Main navigation">
        ...
        <Link href="/" className="flex items-center gap-2 group" aria-label="VCS Home">
          <div className="relative w-10 h-10 flex items-center justify-center bg-transparent">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-transform duration-300 group-hover:scale-105">
              {/* Outer boundary grid */}
              <circle cx="20" cy="20" r="18" stroke="rgba(0, 87, 255, 0.05)" strokeWidth="1" />
              <line x1="20" y1="2" x2="20" y2="38" stroke="rgba(0, 87, 255, 0.05)" strokeWidth="1" />
              <line x1="2" y1="20" x2="38" y2="20" stroke="rgba(0, 87, 255, 0.05)" strokeWidth="1" />
              ...
              <path d="M30 20 L20 20" stroke="#071A52" strokeWidth="2.5" strokeLinecap="round" />

              {/* Endpoints */}
              <circle cx="10" cy="10" r="2.5" fill="#0057FF" />
              <circle cx="10" cy="30" r="2.5" fill="#4DA8FF" />
              <circle cx="30" cy="20" r="2.5" fill="#071A52" />
          ...
          <span className="text-xl font-bold tracking-tight text-text-primary group-hover:text-primary-500 transition-colors">
            VCS
          </span>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-border-light bg-surface-light text-text-muted hover:text-text-primary hover:border-border-medium transition-all text-xs"
            title="Search (Cmd+K)"
          >
            ...
            <span>Search</span>
            <kbd className="hidden sm:inline-block px-1.5 py-0.5 rounded bg-white border border-border-light text-[10px] font-sans font-medium text-text-disabled">
              ⌘K
            </kbd>
          </button>
        ...
        <div className="flex items-center gap-3 lg:hidden">
          ...
          <button
            onClick={triggerSearch}
            className="p-2 rounded-lg border border-border-light bg-surface-light text-text-muted"
            aria-label="Search"
          >
          ...
          <button
            ...
            className="p-2 rounded-lg text-text-secondary hover:text-text-primary hover:bg-surface-soft"
